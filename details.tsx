...
export const codeDetails: SectionDetails = {
    ...
    items: [{
      ...
      title: 'User Sessions',
      link: '/code#sessions',
      description: 'Provide the user session to each function invocation for context and logic'
    }, {
      icon: <SchemaIcon />,
      title: 'JSON Schemas',
      link: '/code#schemas',
...
export const designDetails: SectionDetails = {
    ...
    items: [{
      ...
      description: 'Run a quick build step to avoid having to write up routes yourself'
    },]
}